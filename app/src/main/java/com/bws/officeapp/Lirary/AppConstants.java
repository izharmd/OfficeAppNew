...
public class AppConstants {
    ...
    public static List<MyEventModel> arrMyeventModel = new ArrayList<MyEventModel>();

    public static Calendar main_calendar = Calendar.getInstance(TimeZone.getDefault());
