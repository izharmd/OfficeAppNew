...
//        tv_month_year.setTextColor(Color.parseColor(strHeaderTextColor));
    ...
    public void addEvent(String date, String endDate, String startTime, String endTime, String name,String projectStatus) {
        if (!TextUtils.isEmpty(date) && !TextUtils.isEmpty(startTime) && !TextUtils.isEmpty(endTime) && !TextUtils.isEmpty(name)) {
           ...
           // String tmpEndDate = GlobalMethods.convertDate(endDate, AppConstants.sdfDate, AppConstants.sdfDate);
           ...
           // AppConstants.eventList.add(new EventModel(tmpDate, tmpEndDate, tmpStartTime, tmpEndTime, name));
            AppConstants.eventList.add(new EventModel(date, endDate, startTime, endTime, name,projectStatus));
        }
    }

   /* public void addEvent(String date, String endDate, String startTime, String endTime, String name, int image) {
        if (!TextUtils.isEmpty(date) && !TextUtils.isEmpty(startTime) && !TextUtils.isEmpty(endTime) && !TextUtils.isEmpty(name)) {
            String tmpDate = GlobalMethods.convertDate(date, AppConstants.sdfDate, AppConstants.sdfDate);
            String tmpEndDate = GlobalMethods.convertDate(endDate, AppConstants.sdfDate, AppConstants.sdfDate);
            ...
            String tmpStartTime = GlobalMethods.convertDate(startTime, AppConstants.sdfHourMinute, AppConstants.sdfHourMinute);
            String tmpEndTime = GlobalMethods.convertDate(endTime, AppConstants.sdfHourMinute, AppConstants.sdfHourMinute);
            AppConstants.eventList.add(new EventModel(tmpDate, tmpEndDate, tmpStartTime, tmpEndTime, name, image));
        }
    }
*/
...
//    -------------------------------------------------------------------------
    ...
    private void setMonthView(String sign) {
        ...
        Common.dateCalendarHeader = sdfMonthYear.format(AppConstants.main_calendar.getTime());
            ...
            public void onClick(Date date) {
                ...
                for (int i = 0; i < AppConstants.eventList.size(); i++) {
                    if (AppConstants.eventList.get(i).getStrDate().equals(AppConstants.sdfDate.format(date))) {
                        eventModelList.add(new EventModel(AppConstants.eventList.get(i).getStrDate(), AppConstants.eventList.get(i).getStrEndDate(), AppConstants.eventList.get(i).getStrStartTime(), AppConstants.eventList.get(i).getStrEndTime(), AppConstants.eventList.get(i).getStrName(),AppConstants.eventList.get(i).getProjectStatus()));
                    }
                }
