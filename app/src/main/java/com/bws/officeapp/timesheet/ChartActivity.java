...
public class ChartActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
       ...
       // scalesLinear.ticks("{ interval: 20 }");
        ...
        data.add(new CustomDataEntry("AEML App", 96.5, 2040, 1200, 1600));
        data.add(new CustomDataEntry("Office App", 77.1, 1794, 1124, 1724));
        data.add(new CustomDataEntry("Goya Sports App", 73.2, 2026, 1006, 1806));
        data.add(new CustomDataEntry("Food Hunt", 61.1, 2341, 921, 1621));
