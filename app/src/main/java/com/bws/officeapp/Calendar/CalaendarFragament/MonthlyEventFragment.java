...
public class MonthlyEventFragment  extends Fragment {
    ...
    public void onResume() {
        super.onResume();
      //  Common.calendarFragmentOnResume = "MonthlyEvent";
    ...
    private void initView() {
        ...
        monthlyTaskModel.setTaskName("Blood donation event");
        ...
        monthlyTaskModel1.setTaskName("Cricket event");
        ...
        monthlyTaskModel2.setTaskName("Football event");
        ...
        monthlyTaskModel3.setTaskName("Test event");
